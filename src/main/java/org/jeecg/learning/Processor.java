...
import org.jeecg.learning.util.ObjectUtils;
...
public class Processor extends Thread {
    ...
    public Processor(Socket socket, PropertiesHelper props) {
        this.socket = socket;
        this.props = props;
        try {
    ...
    private String parseFile(InputStream in) {
        ...
        try {
            ...
            if(ObjectUtils.isNotEmpty(httMessage)) {
    ...
    private void sendFile(String filename) {
        File file = new File(props.getRequiredProperty("web.root") + filename);
        if(!file.exists()){
